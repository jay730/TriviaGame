  ...
  var trivia = {
    ...
    displayQuestions: function() {
      ...
      for (var i = 0; i < questionBank.length; i++) {
        ...
        divContainer.append('<div id="questions">' + questionBank[i].questions + '</div>');
...
[
    ...
    {
        questions:"What is the capital of Mexico?",
        answers:["Mexico City", "Lima","Tjuana", "El Paso"],
        correct: "Mexico City"
    }, 
    {
        questions:"What is the Largest Land animal in the world",
        answers:["African Elephant", "Giraffe","Asian Elephant", "Blue Whale"],
        correct: "African Elephant"
    }, 
    {
        questions:"What is the highest mountain in the World?",
        answers:["Mt Everest", "Mt Rushmore","Mt Kilimanjaro", "Mt McKinley"],
        correct: "Mt Everest"
    }, 
    {
        questions:"Who is the current president of the US?",
        answers:["Hillary Clinton", "George Bush","Donald Trump", "Kanye West"],
        correct: "Donald Trump"
    }, 
    {
        questions:"What is Barrack Obama's middle name?",
        answers:["Paul", "Hussein","Mohammed", "Christian"],
        correct: "Hussein"
    },
    ...
    }, 
    {
        ...
        answers:["Vancouver", "Toronto","Quebec", "Ottawa"],
        correct: "Ottawa"
    },
    {
        questions:"Who is the Prince of Wales?",
        answers:["George", "Harry","William", "Charles"],
        correct: "Charles"
    }, 
    {
        questions:"How many surfaces are there in a sphere?",
        answers:["2", "0","4", "1"],
        correct: "0"
    }, 
    {
        questions:"How many month are there in december?",
        answers:["32", "29","31", "30"],
        correct: "31"
    }, 
]
